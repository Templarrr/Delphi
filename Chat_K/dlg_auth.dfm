object AuthDialog: TAuthDialog
  Left = 646
  Top = 53
  BorderStyle = bsDialog
  Caption = #1042#1093#1110#1076' '#1091' '#1073#1072#1079#1091' '#1076#1072#1085#1080#1093
  ClientHeight = 218
  ClientWidth = 319
  Color = clBtnFace
